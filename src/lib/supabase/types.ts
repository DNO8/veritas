...
export type Benefit = Database["public"]["Tables"]["project_benefits"]["Row"];
export type BenefitInsert =
  Database["public"]["Tables"]["project_benefits"]["Insert"];
export type BenefitUpdate =
  Database["public"]["Tables"]["project_benefits"]["Update"];
